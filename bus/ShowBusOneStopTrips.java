 ...
 * @author ismai
 */
public class ShowBusOneStopTrips extends javax.swing.JFrame {
 private HashMap <String,ArrayList<String>> tripHash=new HashMap <>();
    Bus b=new Bus();
    DefaultTableModel model;
    private String ID;
    /**
     * Creates new form ShowBusOneStopTrips
     */
    public ShowBusOneStopTrips() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Source", "The stop", "Destination", "Date", "Time", "Price"
            }
        ) {
...
public String getID() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowBusOneStopTrips.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowBusOneStopTrips().setVisible(true);
            }
        });
    }
