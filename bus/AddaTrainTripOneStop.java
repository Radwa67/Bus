 ...
 * @author ismai
 */
public class AddaTrainTripOneStop extends javax.swing.JFrame {
Manager m = new Manager();
    /**
     * Creates new form AddaTrainTripOneStop
     */
    public AddaTrainTripOneStop() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
 m.openFileWTrips(  TripID.getText(), Source.getText(), TheStop.getText(), Destination.getText(), Date.getText() ,Time.getText() , Price.getText(), "trainTripsOneStop.txt", 36);
     setVisible(false);
 new ManagerProfile().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddaTrainTripOneStop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
