 ...
 * @author ismai
 */
public class ShowBusTwoStopTrips extends javax.swing.JFrame {
private HashMap <String,ArrayList<String>> tripHash=new HashMap <>();
    Bus b=new Bus();
    DefaultTableModel model;
    private String ID;
    /**
     * Creates new form ShowBusTwoStopTrips
     */
    public ShowBusTwoStopTrips() {
        initComponents();
    ...
    private void OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OkActionPerformed
       ...
       valid = b.searchExistence(tripHash,ID);
       if(valid==false)
       {
...
public String getID() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowBusTwoStopTrips.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowBusTwoStopTrips().setVisible(true);
            }
        });
    }
